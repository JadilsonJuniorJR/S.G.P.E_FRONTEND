        ...
        <Col sm={12} md={3} lg={3} className={`${styles.menu_lateral}`}>
          ...
          <div className={styles.caixa_interna}>
            ...
            <Scroll to="Conteiner_Rotas" smooth={true} duration={150} >
              ...
              <Link to='/'> <Button variant="outline-light" className={`${styles.botao}`}  size="lg">Home</Button> </Link>
            </Scroll>
            <Scroll to="Conteiner_Rotas" smooth={true} duration={150}>
              {/* Link com o Botão para a rota Eventos */}
              <Link to='/Eventos_Opcoes'> <Button variant="outline-light" className={`${styles.botao}`} size="lg">Eventos</Button> </Link>
            </Scroll>
            <Link to='/login'> <Button variant="outline-light" className={`${styles.botao}`} size="lg">Logar</Button> </Link>
            <Link to='/eventos'> <Button variant="outline-light" className={`${styles.botao}`} size="lg">Sobre</Button> </Link>
          </div>
        </Col>
